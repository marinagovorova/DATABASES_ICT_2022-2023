...
-- Started on 2023-03-16 21:55:15
...
--
-- TOC entry 3424 (class 0 OID 16604)
-- Dependencies: 226
-- Data for Name: attestations; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.attestations (student_personnel_number, educator_personnel_number, disc_in_curr_id, mark) FROM stdin;
333001	111111	2	5A
333001	111222	1	4B
333001	111333	3	5A
333001	111444	4	Зачёт
333002	111111	2	4B
333002	111222	1	4B
333002	111333	3	4C
333002	111444	4	Зачёт
333003	111111	2	5A
333003	111222	1	5A
333003	111333	3	5A
333003	111444	4	Зачёт
333004	111111	2	3D
333004	111222	1	3D
333004	111333	3	3D
333004	111555	4	Зачёт
333005	111111	2	5A
333005	111222	1	5A
333005	111333	3	5A
333005	111444	4	Зачёт
333006	111111	2	4C
333006	111222	1	4B
333006	111333	3	5A
333006	111444	4	Зачёт
\.
...
--
-- TOC entry 3417 (class 0 OID 16502)
-- Dependencies: 219
...
--
-- TOC entry 3412 (class 0 OID 16452)
-- Dependencies: 214
...
--
-- TOC entry 3420 (class 0 OID 16527)
-- Dependencies: 222
...
--
-- TOC entry 3414 (class 0 OID 16462)
-- Dependencies: 216
...
--
-- TOC entry 3415 (class 0 OID 16477)
-- Dependencies: 217
...
--
-- TOC entry 3421 (class 0 OID 16532)
-- Dependencies: 223
...
--
-- TOC entry 3425 (class 0 OID 16624)
-- Dependencies: 227
-- Data for Name: schedule_rows; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.schedule_rows (st_group_id, educator_personnel_number, disc_in_curr_id, auditorium_id, schedule_date) FROM stdin;
2	111111	2	5	2023-01-17 10:00:00+03
2	111222	1	5	2023-01-25 10:00:00+03
2	111333	3	6	2023-01-22 10:00:00+03
2	111444	4	2	2022-12-21 15:20:00+03
2	111555	4	2	2022-12-21 08:20:00+03
\.


--
-- TOC entry 3418 (class 0 OID 16512)
-- Dependencies: 220
...
--
-- TOC entry 3419 (class 0 OID 16522)
-- Dependencies: 221
...
COPY public.venues (venue_id, venue_name) FROM stdin;
1	Кронверский
2	Ломоносова
3	Биржевая
\.
...
--
-- TOC entry 3249 (class 2606 OID 16608)
...
--
-- TOC entry 3233 (class 2606 OID 16496)
...
--
-- TOC entry 3235 (class 2606 OID 16506)
...
--
-- TOC entry 3247 (class 2606 OID 16566)
...
--
-- TOC entry 3231 (class 2606 OID 16481)
...
--
-- TOC entry 3243 (class 2606 OID 16536)
...
--
-- TOC entry 3237 (class 2606 OID 16516)
...
--
-- TOC entry 3245 (class 2606 OID 16551)
...
--
-- TOC entry 3239 (class 2606 OID 16526)
...
--
-- TOC entry 3227 (class 2606 OID 16461)
...
--
-- TOC entry 3263 (class 2606 OID 16619)
...
--
-- TOC entry 3264 (class 2606 OID 16614)
...
--
-- TOC entry 3265 (class 2606 OID 16609)
...
--
-- TOC entry 3261 (class 2606 OID 16567)
...
--
-- TOC entry 3258 (class 2606 OID 16537)
...
--
-- TOC entry 3268 (class 2606 OID 16634)
...
--
-- TOC entry 3257 (class 2606 OID 16517)
...
--
-- TOC entry 3259 (class 2606 OID 16557)
...
--
-- TOC entry 3260 (class 2606 OID 16552)
...
-- Completed on 2023-03-16 21:55:15
